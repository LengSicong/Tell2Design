...
class DataTrainingArguments:
    ...
    boundary_in_where: str = field(
        default=None, metadata={"help": "Where to incorporate boundary information"}
    )

    exp: str = field(
        default='None', metadata={"help": "hint of what is this experiment running"}
    )

    editing_data : bool = field(
        default=False, metadata={"help": "If true, produce data for Editing Model during evaluation"}
    )
