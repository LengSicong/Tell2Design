...
# load all images
dir_paths = []
for root, dirs, files in os.walk('/home/sicong/imagen-sicong/outputs/unet1_cond3.0_sample512_start256_lr1e-5_dim256_nofp16_human_data/eval_samples/'):
...
for img_id in tqdm(dir_paths):
    ...
    pred_image = cv2.imread(os.path.join(f"/home/sicong/imagen-sicong/outputs/unet1_cond3.0_sample512_start256_lr1e-5_dim256_nofp16_human_data/eval_samples/{img_id}"))
